...
## Direct entry into 
We first use the `data.frame` function from the  base package to greate the data frame.
...
Below we first describe how to manually enter data into R. Our aim is to create a tibble by using the `tibble` function.
